...
public class CaptureActivity extends Activity {
	...
	private void findViewById() {
		...
		jumpWebView= (Button) findViewById(R.id.capture_jump_webview);
	...
	private void addEvents() {
		...
		jumpWebView.setOnClickListener(new OnClickListener() {
